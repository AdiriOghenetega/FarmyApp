...
export default function CartAddressPage() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={[styles.editAddressContainer,globalStyles.shadowContainer]}>
        ...
        <Text style={styles.mainAddress}>No 23, Command Secondary School, via Omi-Adio, Apata, Ibadan</Text>
      </View>
      <View style={[styles.editAddressContainer,globalStyles.shadowContainer,{height:137}]}>
      <View style={styles.carIconContainer}>
      <MaterialCommunityIcons name="car-connected" size={24} color={colors.otherprimary} />
