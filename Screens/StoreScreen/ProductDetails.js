...
import {View, StyleSheet, Text, SafeAreaView, Platform, TouchableOpacity, Image, ScrollView} from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.productHeader}>
            ...
            <TouchableOpacity style={styles.cartContainer}>
                <FontAwesome5 name="shopping-cart" size={24} color={colors.primary} />
        ...
        <View style={styles.productDescription}>
            <Text style={styles.productDescriptionText}>
                ...
                revenue, serving over 69 million customers daily in 
                over 100 countries across 37,855 outlets as of the year 2018.
            </Text>
        </View>
